...
class Password:
    ...
    def check_password(password):
        ...
        The password necessities can be changed in the PasswordEspecifications
    ...
    def hibp(password):
        ...
        req = get('https://api.pwnedpasswords.com/range/' + pas_in_sha1[0:5], timeout=5)
